...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// </summary>
        public static string ACITIVITY_NOT_FOUND {
            get {
                return ResourceManager.GetString("ACITIVITY_NOT_FOUND", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Consulta uma cadeia de caracteres localizada semelhante a The end date of the trip must be equl to or later than the start date..
        /// </summary>
        public static string END_DATE_MUST_BE_LATER_START_DATE {
            get {
                return ResourceManager.GetString("END_DATE_MUST_BE_LATER_START_DATE", resourceCulture);
            }
        }
